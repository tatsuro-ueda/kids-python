...
- [ ] GSC確認ファイルの配置とデプロイ（Claude担当 — ユーザーからファイル名を受け取り次第）
...
- [ ] ローカルの最終確認（Claude担当）
  - [ ] robots.txt の内容が正しいか再確認
  - [ ] sitemap.xml の内容が正しいか再確認
  - [ ] canonical URLが入っているか確認

- [ ] marketing-problems.md の P1 ステータスを更新（Claude担当）
  - [ ] 「Google Search Consoleへの登録・インデックス確認がまだ」→ 完了表記に更新
